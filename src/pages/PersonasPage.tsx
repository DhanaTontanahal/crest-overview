...
const personas = [
  { role: 'LTC CEO', icon: Building2, color: 'from-primary to-primary/70' },
    ...
    <div className="space-y-6 animate-fade-in" style={{ animationFillMode: 'forwards' }}>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
        {personas.map((persona, idx) => (
          ...
          >
            <div className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${persona.color} flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-300`}>
